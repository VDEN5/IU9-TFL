...
\begin{itemize}
    \item $\omega$ содержит подстроку $ba$ или $bb$, и тогда любое слово, эквивалентное $\omega$, также содержит хотя бы одну из этих подстрок
    \item $\omega$ не содержит подстрок $ba$ и $bb$, и тогда для любого слова $\omega'$, эквивалентного $\omega$, выполняется $|\omega|_a \equiv |\omega'|_a \pmod{3}$
\end{itemize}
